    ...
    public class Program
    {
        public static void Main()
        {
            using (var db = new BloggingContext())
            {
                ...
                // Force the entire table to load into memory before iterating over it. EF Core sometimes won't allow you to
                // do read operations on a SQL table while you're iterating through it so we need to load all of its rows first
